  ...
  getPayload(parameters, request) {
    ...
    if (parameters !== null && typeof parameters === "object" && Object.getPrototypeOf(parameters) === Object.prototype) {
      ...
      Object.entries(parameters).forEach(([key, value]) => {
        ...
        if (paramDefinition && paramDefinition.type && typeof paramDefinition.type.formatBody === "function") {
          payloadObject[key] = paramDefinition.type.formatBody(value);
        } else if (paramDefinition && paramDefinition.type && paramDefinition.type.elementType && typeof paramDefinition.type.elementType.formatBody === "function") {
