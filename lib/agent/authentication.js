...
exports.authenticate = function (agent, endpointUrl) {
  ...
  if (Object.prototype.hasOwnProperty.call(agent, "settings") &&
      agent.settings && Object.prototype.hasOwnProperty.call(agent.settings, "auth") &&
      agent.settings.auth && Object.prototype.hasOwnProperty.call(agent.settings.auth, "type")) {
...
exports.authenticateAuto = function (agent, endpointUrl) {
  return new Promise((resolve, reject) => {
    let authenticator;
    if (
      Array.isArray(exports.AUTHENTICATORS_AUTO_ORDER) &&
