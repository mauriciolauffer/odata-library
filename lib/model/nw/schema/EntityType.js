...
class EntityType extends ComplexType {
  ...
  constructor(rawMetadata, model) {
    ...
    Object.defineProperty(this, "hasStream", {
      get: () => {
        return rawMetadata.$ && rawMetadata.$["m:HasStream"] === "true";
      },
    });

    let navigationProperties = (this.raw && this.raw.NavigationProperty || []).map(
  ...
  getLegacyApiObject() {
    return Object.assign(super.getLegacyApiObject(), {
      ...
      NavigationProperties: Object.fromEntries(
        this.navigationProperties.map((np) => [np.getLegacyApiObject().Name, np.getLegacyApiObject()])
      ),
    });
  }
  ...
  _createKey() {
    if (
      !Object.prototype.hasOwnProperty.call(this.raw, "Key") ||
      !Array.isArray(this.raw.Key) ||
