...
class BoundObject extends AnnotationTarget {
  ...
  constructor(rawMetadata) {
    ...
    if (Array.isArray(rawMetadata.ReturnType)) {
    ...
    let parameters = (rawMetadata.Parameter || []).map((md) => new Parameter(md));
  ...
  initSchemaDependentProperties(schema) {
    if (Object.prototype.hasOwnProperty.call(this, "returnType")) {
