...
class NavigationProperty extends AnnotationTarget {
  ...
  constructor(rawMetadata) {
    ...
    if (Object.prototype.hasOwnProperty.call(this.raw.$, "Partner")) {
  ...
  initSchemaDependentProperties(schema) {
    ...
    if (isCollection) {
      if (Object.prototype.hasOwnProperty.call(this.raw.$, "Nullable")) {
        throw new Error(
  ...
  _processOnDelete(rawMetadata) {
    if (Object.prototype.hasOwnProperty.call(rawMetadata, "OnDelete")) {
